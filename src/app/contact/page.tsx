...
export default function ContactPage() {
  ...
  const contactInfo = [
    {
      title: 'Email Us',
      value: 'info@zambiaproperty.com',
      link: 'mailto:info@zambiaproperty.com',
      icon: (
      ...
      <main className="min-h-screen bg-cream pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-serif font-bold text-neutral-900 mb-4">Contact Us</h1>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-8 shadow-sm h-full">
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium text-neutral-900">{info.title}</div>
                ...
                <div className="mt-8 pt-8 border-t border-neutral-100">
                  <h3 className="font-semibold text-neutral-900 mb-4">Office Hours</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                ...
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-neutral-600 mb-6">Thank you for contacting us. We'll get back to you soon.</p>
                    <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-neutral-200 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors resize-none"
